...
function checkFirestoreAccess() {
    return __awaiter(this, void 0, void 0, function () {
        var collectionRef, querySnapshot, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    collectionRef = app_1.default.firestore().collection('test');
                    console.log('Retrieved collection reference:', collectionRef.path);
                    return [4 /*yield*/, collectionRef.limit(1).get()];
                case 1:
                    querySnapshot = _a.sent();
                    // If we successfully retrieved data, Firestore is accessible
                    return [2 /*return*/, querySnapshot.size > 0];
                case 2:
                    error_1 = _a.sent();
...
checkFirestoreAccess().then(function (isAccessible) {
    if (isAccessible) {
